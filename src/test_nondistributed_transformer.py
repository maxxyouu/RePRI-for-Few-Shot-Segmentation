...
def episodic_validate(args: argparse.Namespace,
    ...
    for run in tqdm(range(args.n_runs)):
        ...
        for e in tqdm(range(nb_episodes)):
            ...
            classifier.init_att_prototypes(features_s, features_q, gt_s, gt_q, classes, callback)
            ...
            batch_deltas = classifier.attention_RePRI(features_s, features_q, gt_s, gt_q, classes, n_shots, callback)
